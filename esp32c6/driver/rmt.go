...
*     - ESP_OK Success
 */
// llgo:link RmtChannelT.RmtSetRxThrIntrEn C.rmt_set_rx_thr_intr_en
func (recv_ RmtChannelT) RmtSetRxThrIntrEn(en bool, evt_thresh c.Uint16T) EspErrT {
	return 0
}
...
*     - ESP_OK Success
 */
// llgo:link RmtChannelT.RmtAddChannelToGroup C.rmt_add_channel_to_group
func (recv_ RmtChannelT) RmtAddChannelToGroup() EspErrT {
	return 0
}
...
*     - ESP_OK Success
 */
// llgo:link RmtChannelT.RmtRemoveChannelFromGroup C.rmt_remove_channel_from_group
func (recv_ RmtChannelT) RmtRemoveChannelFromGroup() EspErrT {
	return 0
}
 ...
 *      - ESP_OK Success
 */
// llgo:link RmtChannelT.RmtSetTxLoopCount C.rmt_set_tx_loop_count
func (recv_ RmtChannelT) RmtSetTxLoopCount(count c.Uint32T) EspErrT {
	return 0
}
 ...
 *      - ESP_OK Success
 */
// llgo:link RmtChannelT.RmtEnableTxLoopAutostop C.rmt_enable_tx_loop_autostop
func (recv_ RmtChannelT) RmtEnableTxLoopAutostop(en bool) EspErrT {
	return 0
}
