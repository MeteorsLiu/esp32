 ...
 * @endcode
 */
//go:linkname XEventGroupCreateStatic C.xEventGroupCreateStatic
func XEventGroupCreateStatic(pxEventGroupBuffer *c.Int) EventGroupHandleT
...
func XEventGroupGetStaticBuffer(xEventGroup EventGroupHandleT, ppxEventGroupBuffer **c.Int) c.Int
