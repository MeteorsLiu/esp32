...
const MCPWM_CMPR0_A_UPMETHOD_S = 0
const MCPWM_CMPR0_B_UPMETHOD_S = 4
const MCPWM_CMPR0_A_SHDW_FULL_S = 8
const MCPWM_CMPR0_B_SHDW_FULL_S = 9
const MCPWM_CMPR0_A_S = 0
const MCPWM_CMPR0_B_S = 0
...
const MCPWM_DB0_FED_UPMETHOD_S = 0
const MCPWM_DB0_RED_UPMETHOD_S = 4
const MCPWM_DB0_DEB_MODE_S = 8
const MCPWM_DB0_A_OUTSWAP_S = 9
const MCPWM_DB0_B_OUTSWAP_S = 10
const MCPWM_DB0_RED_INSEL_S = 11
const MCPWM_DB0_FED_INSEL_S = 12
const MCPWM_DB0_RED_OUTINVERT_S = 13
const MCPWM_DB0_FED_OUTINVERT_S = 14
const MCPWM_DB0_A_OUTBYPASS_S = 15
const MCPWM_DB0_B_OUTBYPASS_S = 16
const MCPWM_DB0_CLK_SEL_S = 17
const MCPWM_DB0_FED_S = 0
const MCPWM_DB0_RED_S = 0
const MCPWM_CHOPPER0_EN_S = 0
const MCPWM_CHOPPER0_PRESCALE_S = 1
const MCPWM_CHOPPER0_DUTY_S = 5
const MCPWM_CHOPPER0_OSHTWTH_S = 8
const MCPWM_CHOPPER0_OUT_INVERT_S = 12
const MCPWM_CHOPPER0_IN_INVERT_S = 13
const MCPWM_TZ0_SW_CBC_S = 0
const MCPWM_TZ0_F2_CBC_S = 1
const MCPWM_TZ0_F1_CBC_S = 2
const MCPWM_TZ0_F0_CBC_S = 3
const MCPWM_TZ0_SW_OST_S = 4
const MCPWM_TZ0_F2_OST_S = 5
const MCPWM_TZ0_F1_OST_S = 6
const MCPWM_TZ0_F0_OST_S = 7
const MCPWM_TZ0_A_CBC_D_S = 8
const MCPWM_TZ0_A_CBC_U_S = 10
const MCPWM_TZ0_A_OST_D_S = 12
const MCPWM_TZ0_A_OST_U_S = 14
const MCPWM_TZ0_B_CBC_D_S = 16
const MCPWM_TZ0_B_CBC_U_S = 18
const MCPWM_TZ0_B_OST_D_S = 20
const MCPWM_TZ0_B_OST_U_S = 22
const MCPWM_TZ0_CLR_OST_S = 0
const MCPWM_TZ0_CBCPULSE_S = 1
const MCPWM_TZ0_FORCE_CBC_S = 3
const MCPWM_TZ0_FORCE_OST_S = 4
const MCPWM_TZ0_CBC_ON_S = 0
const MCPWM_TZ0_OST_ON_S = 1
const MCPWM_CMPR1_A_UPMETHOD_S = 0
const MCPWM_CMPR1_B_UPMETHOD_S = 4
const MCPWM_CMPR1_A_SHDW_FULL_S = 8
const MCPWM_CMPR1_B_SHDW_FULL_S = 9
const MCPWM_CMPR1_A_S = 0
const MCPWM_CMPR1_B_S = 0
...
const MCPWM_DB1_FED_UPMETHOD_S = 0
const MCPWM_DB1_RED_UPMETHOD_S = 4
const MCPWM_DB1_DEB_MODE_S = 8
const MCPWM_DB1_A_OUTSWAP_S = 9
const MCPWM_DB1_B_OUTSWAP_S = 10
const MCPWM_DB1_RED_INSEL_S = 11
const MCPWM_DB1_FED_INSEL_S = 12
const MCPWM_DB1_RED_OUTINVERT_S = 13
const MCPWM_DB1_FED_OUTINVERT_S = 14
const MCPWM_DB1_A_OUTBYPASS_S = 15
const MCPWM_DB1_B_OUTBYPASS_S = 16
const MCPWM_DB1_CLK_SEL_S = 17
const MCPWM_DB1_FED_S = 0
const MCPWM_DB1_RED_S = 0
const MCPWM_CHOPPER1_EN_S = 0
const MCPWM_CHOPPER1_PRESCALE_S = 1
const MCPWM_CHOPPER1_DUTY_S = 5
const MCPWM_CHOPPER1_OSHTWTH_S = 8
const MCPWM_CHOPPER1_OUT_INVERT_S = 12
const MCPWM_CHOPPER1_IN_INVERT_S = 13
const MCPWM_TZ1_SW_CBC_S = 0
const MCPWM_TZ1_F2_CBC_S = 1
const MCPWM_TZ1_F1_CBC_S = 2
const MCPWM_TZ1_F0_CBC_S = 3
const MCPWM_TZ1_SW_OST_S = 4
const MCPWM_TZ1_F2_OST_S = 5
const MCPWM_TZ1_F1_OST_S = 6
const MCPWM_TZ1_F0_OST_S = 7
const MCPWM_TZ1_A_CBC_D_S = 8
const MCPWM_TZ1_A_CBC_U_S = 10
const MCPWM_TZ1_A_OST_D_S = 12
const MCPWM_TZ1_A_OST_U_S = 14
const MCPWM_TZ1_B_CBC_D_S = 16
const MCPWM_TZ1_B_CBC_U_S = 18
const MCPWM_TZ1_B_OST_D_S = 20
const MCPWM_TZ1_B_OST_U_S = 22
const MCPWM_TZ1_CLR_OST_S = 0
const MCPWM_TZ1_CBCPULSE_S = 1
const MCPWM_TZ1_FORCE_CBC_S = 3
const MCPWM_TZ1_FORCE_OST_S = 4
const MCPWM_TZ1_CBC_ON_S = 0
const MCPWM_TZ1_OST_ON_S = 1
const MCPWM_CMPR2_A_UPMETHOD_S = 0
const MCPWM_CMPR2_B_UPMETHOD_S = 4
const MCPWM_CMPR2_A_SHDW_FULL_S = 8
const MCPWM_CMPR2_B_SHDW_FULL_S = 9
const MCPWM_CMPR2_A_S = 0
const MCPWM_CMPR2_B_S = 0
...
const MCPWM_DB2_FED_UPMETHOD_S = 0
const MCPWM_DB2_RED_UPMETHOD_S = 4
const MCPWM_DB2_DEB_MODE_S = 8
const MCPWM_DB2_A_OUTSWAP_S = 9
const MCPWM_DB2_B_OUTSWAP_S = 10
const MCPWM_DB2_RED_INSEL_S = 11
const MCPWM_DB2_FED_INSEL_S = 12
const MCPWM_DB2_RED_OUTINVERT_S = 13
const MCPWM_DB2_FED_OUTINVERT_S = 14
const MCPWM_DB2_A_OUTBYPASS_S = 15
const MCPWM_DB2_B_OUTBYPASS_S = 16
const MCPWM_DB2_CLK_SEL_S = 17
const MCPWM_DB2_FED_S = 0
const MCPWM_DB2_RED_S = 0
const MCPWM_CHOPPER2_EN_S = 0
const MCPWM_CHOPPER2_PRESCALE_S = 1
const MCPWM_CHOPPER2_DUTY_S = 5
const MCPWM_CHOPPER2_OSHTWTH_S = 8
const MCPWM_CHOPPER2_OUT_INVERT_S = 12
const MCPWM_CHOPPER2_IN_INVERT_S = 13
const MCPWM_TZ2_SW_CBC_S = 0
const MCPWM_TZ2_F2_CBC_S = 1
const MCPWM_TZ2_F1_CBC_S = 2
const MCPWM_TZ2_F0_CBC_S = 3
const MCPWM_TZ2_SW_OST_S = 4
const MCPWM_TZ2_F2_OST_S = 5
const MCPWM_TZ2_F1_OST_S = 6
const MCPWM_TZ2_F0_OST_S = 7
const MCPWM_TZ2_A_CBC_D_S = 8
const MCPWM_TZ2_A_CBC_U_S = 10
const MCPWM_TZ2_A_OST_D_S = 12
const MCPWM_TZ2_A_OST_U_S = 14
const MCPWM_TZ2_B_CBC_D_S = 16
const MCPWM_TZ2_B_CBC_U_S = 18
const MCPWM_TZ2_B_OST_D_S = 20
const MCPWM_TZ2_B_OST_U_S = 22
const MCPWM_TZ2_CLR_OST_S = 0
const MCPWM_TZ2_CBCPULSE_S = 1
const MCPWM_TZ2_FORCE_CBC_S = 3
const MCPWM_TZ2_FORCE_OST_S = 4
const MCPWM_TZ2_CBC_ON_S = 0
const MCPWM_TZ2_OST_ON_S = 1
...
const MCPWM_CMPR0_TEA_INT_ENA_S = 15
const MCPWM_CMPR1_TEA_INT_ENA_S = 16
const MCPWM_CMPR2_TEA_INT_ENA_S = 17
const MCPWM_CMPR0_TEB_INT_ENA_S = 18
const MCPWM_CMPR1_TEB_INT_ENA_S = 19
const MCPWM_CMPR2_TEB_INT_ENA_S = 20
const MCPWM_TZ0_CBC_INT_ENA_S = 21
const MCPWM_TZ1_CBC_INT_ENA_S = 22
const MCPWM_TZ2_CBC_INT_ENA_S = 23
const MCPWM_TZ0_OST_INT_ENA_S = 24
const MCPWM_TZ1_OST_INT_ENA_S = 25
const MCPWM_TZ2_OST_INT_ENA_S = 26
...
const MCPWM_CMPR0_TEA_INT_RAW_S = 15
const MCPWM_CMPR1_TEA_INT_RAW_S = 16
const MCPWM_CMPR2_TEA_INT_RAW_S = 17
const MCPWM_CMPR0_TEB_INT_RAW_S = 18
const MCPWM_CMPR1_TEB_INT_RAW_S = 19
const MCPWM_CMPR2_TEB_INT_RAW_S = 20
const MCPWM_TZ0_CBC_INT_RAW_S = 21
const MCPWM_TZ1_CBC_INT_RAW_S = 22
const MCPWM_TZ2_CBC_INT_RAW_S = 23
const MCPWM_TZ0_OST_INT_RAW_S = 24
const MCPWM_TZ1_OST_INT_RAW_S = 25
const MCPWM_TZ2_OST_INT_RAW_S = 26
...
const MCPWM_CMPR0_TEA_INT_ST_S = 15
const MCPWM_CMPR1_TEA_INT_ST_S = 16
const MCPWM_CMPR2_TEA_INT_ST_S = 17
const MCPWM_CMPR0_TEB_INT_ST_S = 18
const MCPWM_CMPR1_TEB_INT_ST_S = 19
const MCPWM_CMPR2_TEB_INT_ST_S = 20
const MCPWM_TZ0_CBC_INT_ST_S = 21
const MCPWM_TZ1_CBC_INT_ST_S = 22
const MCPWM_TZ2_CBC_INT_ST_S = 23
const MCPWM_TZ0_OST_INT_ST_S = 24
const MCPWM_TZ1_OST_INT_ST_S = 25
const MCPWM_TZ2_OST_INT_ST_S = 26
...
const MCPWM_CMPR0_TEA_INT_CLR_S = 15
const MCPWM_CMPR1_TEA_INT_CLR_S = 16
const MCPWM_CMPR2_TEA_INT_CLR_S = 17
const MCPWM_CMPR0_TEB_INT_CLR_S = 18
const MCPWM_CMPR1_TEB_INT_CLR_S = 19
const MCPWM_CMPR2_TEB_INT_CLR_S = 20
const MCPWM_TZ0_CBC_INT_CLR_S = 21
const MCPWM_TZ1_CBC_INT_CLR_S = 22
const MCPWM_TZ2_CBC_INT_CLR_S = 23
const MCPWM_TZ0_OST_INT_CLR_S = 24
const MCPWM_TZ1_OST_INT_CLR_S = 25
const MCPWM_TZ2_OST_INT_CLR_S = 26
const MCPWM_CAP0_INT_CLR_S = 27
const MCPWM_CAP1_INT_CLR_S = 28
const MCPWM_CAP2_INT_CLR_S = 29
const MCPWM_EVT_TIMER0_STOP_EN_S = 0
const MCPWM_EVT_TIMER1_STOP_EN_S = 1
const MCPWM_EVT_TIMER2_STOP_EN_S = 2
const MCPWM_EVT_TIMER0_TEZ_EN_S = 3
const MCPWM_EVT_TIMER1_TEZ_EN_S = 4
const MCPWM_EVT_TIMER2_TEZ_EN_S = 5
const MCPWM_EVT_TIMER0_TEP_EN_S = 6
const MCPWM_EVT_TIMER1_TEP_EN_S = 7
const MCPWM_EVT_TIMER2_TEP_EN_S = 8
const MCPWM_EVT_OP0_TEA_EN_S = 9
const MCPWM_EVT_OP1_TEA_EN_S = 10
const MCPWM_EVT_OP2_TEA_EN_S = 11
const MCPWM_EVT_OP0_TEB_EN_S = 12
const MCPWM_EVT_OP1_TEB_EN_S = 13
const MCPWM_EVT_OP2_TEB_EN_S = 14
const MCPWM_EVT_F0_EN_S = 15
const MCPWM_EVT_F1_EN_S = 16
const MCPWM_EVT_F2_EN_S = 17
const MCPWM_EVT_F0_CLR_EN_S = 18
const MCPWM_EVT_F1_CLR_EN_S = 19
const MCPWM_EVT_F2_CLR_EN_S = 20
const MCPWM_EVT_TZ0_CBC_EN_S = 21
const MCPWM_EVT_TZ1_CBC_EN_S = 22
const MCPWM_EVT_TZ2_CBC_EN_S = 23
const MCPWM_EVT_TZ0_OST_EN_S = 24
const MCPWM_EVT_TZ1_OST_EN_S = 25
const MCPWM_EVT_TZ2_OST_EN_S = 26
const MCPWM_EVT_CAP0_EN_S = 27
const MCPWM_EVT_CAP1_EN_S = 28
const MCPWM_EVT_CAP2_EN_S = 29
const MCPWM_TASK_CMPR0_A_UP_EN_S = 0
const MCPWM_TASK_CMPR1_A_UP_EN_S = 1
const MCPWM_TASK_CMPR2_A_UP_EN_S = 2
const MCPWM_TASK_CMPR0_B_UP_EN_S = 3
const MCPWM_TASK_CMPR1_B_UP_EN_S = 4
const MCPWM_TASK_CMPR2_B_UP_EN_S = 5
const MCPWM_TASK_GEN_STOP_EN_S = 6
const MCPWM_TASK_TIMER0_SYNC_EN_S = 7
const MCPWM_TASK_TIMER1_SYNC_EN_S = 8
const MCPWM_TASK_TIMER2_SYNC_EN_S = 9
const MCPWM_TASK_TIMER0_PERIOD_UP_EN_S = 10
const MCPWM_TASK_TIMER1_PERIOD_UP_EN_S = 11
const MCPWM_TASK_TIMER2_PERIOD_UP_EN_S = 12
const MCPWM_TASK_TZ0_OST_EN_S = 13
const MCPWM_TASK_TZ1_OST_EN_S = 14
const MCPWM_TASK_TZ2_OST_EN_S = 15
const MCPWM_TASK_CLR0_OST_EN_S = 16
const MCPWM_TASK_CLR1_OST_EN_S = 17
const MCPWM_TASK_CLR2_OST_EN_S = 18
const MCPWM_TASK_CAP0_EN_S = 19
const MCPWM_TASK_CAP1_EN_S = 20
const MCPWM_TASK_CAP2_EN_S = 21
