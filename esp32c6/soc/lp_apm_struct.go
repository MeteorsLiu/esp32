...
type LpApmRegion2AddrStartRegT struct {
	Val c.Uint32T
}
...
type LpApmRegion2AddrEndRegT struct {
	Val c.Uint32T
}
...
type LpApmRegion3AddrStartRegT struct {
	Val c.Uint32T
}
...
type LpApmRegion3AddrEndRegT struct {
	Val c.Uint32T
}
...
type LpApmRegion2PmsAttrRegT struct {
	Val c.Uint32T
}
...
type LpApmRegion3PmsAttrRegT struct {
	Val c.Uint32T
}
...
type LpApmM1StatusClrRegT struct {
	Val c.Uint32T
}
...
type LpApmM1ExceptionInfo0RegT struct {
	Val c.Uint32T
}
...
type LpApmM1ExceptionInfo1RegT struct {
	Val c.Uint32T
}
...
type LpApmDevT struct {
	...
	Region2AddrStart LpApmRegion2AddrStartRegT
	Region2AddrEnd   LpApmRegion2AddrEndRegT
	Region2PmsAttr   LpApmRegion2PmsAttrRegT
	Region3AddrStart LpApmRegion3AddrStartRegT
	Region3AddrEnd   LpApmRegion3AddrEndRegT
	Region3PmsAttr   LpApmRegion3PmsAttrRegT
	...
	M1Status         LpApmM1StatusRegT
	M1StatusClr      LpApmM1StatusClrRegT
	M1ExceptionInfo0 LpApmM1ExceptionInfo0RegT
	M1ExceptionInfo1 LpApmM1ExceptionInfo1RegT
