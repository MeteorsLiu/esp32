...
type RmtDevT struct {
	Chndata  [2]RmtChndataRegT
	Chmdata  [2]RmtChmdataRegT
	Chnconf0 [2]RmtChnconf0RegT
	Chmconf  [2]struct {
		Conf0 RmtChmconf0RegT
		Conf1 RmtChmconf1RegT
	}
	Chnstatus      [2]RmtChnstatusRegT
	Chmstatus      [2]RmtChmstatusRegT
	IntRaw         RmtIntRawRegT
	IntSt          RmtIntStRegT
	IntEna         RmtIntEnaRegT
	IntClr         RmtIntClrRegT
	ChncarrierDuty [2]RmtChncarrierDutyRegT
	ChmRxCarrierRm [2]RmtChmRxCarrierRmRegT
	ChnTxLim       [2]RmtChnTxLimRegT
	ChmRxLim       [2]RmtChmRxLimRegT
	SysConf        RmtSysConfRegT
	TxSim          RmtTxSimRegT
	RefCntRst      RmtRefCntRstRegT
	Reserved074    [22]c.Uint32T
	Date           RmtDateRegT
}
