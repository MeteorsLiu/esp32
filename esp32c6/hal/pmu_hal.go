...
// llgo:link (*PmuHalContextT).PmuHalHpSetSleepModemBackupEnable C.pmu_hal_hp_set_sleep_modem_backup_enable
func (recv_ *PmuHalContextT) PmuHalHpSetSleepModemBackupEnable() {
}

// llgo:link (*PmuHalContextT).PmuHalHpSetSleepModemBackupDisable C.pmu_hal_hp_set_sleep_modem_backup_disable
func (recv_ *PmuHalContextT) PmuHalHpSetSleepModemBackupDisable() {
}

// llgo:link (*PmuHalContextT).PmuHalHpSetModemActiveBackupEnable C.pmu_hal_hp_set_modem_active_backup_enable
func (recv_ *PmuHalContextT) PmuHalHpSetModemActiveBackupEnable() {
}

// llgo:link (*PmuHalContextT).PmuHalHpSetModemActiveBackupDisable C.pmu_hal_hp_set_modem_active_backup_disable
func (recv_ *PmuHalContextT) PmuHalHpSetModemActiveBackupDisable() {
}
