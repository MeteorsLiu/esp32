 ...
 */
//go:linkname EspCacheFreezeExtMemCache C.esp_cache_freeze_ext_mem_cache
func EspCacheFreezeExtMemCache()
 ...
 */
//go:linkname EspCacheUnfreezeExtMemCache C.esp_cache_unfreeze_ext_mem_cache
func EspCacheUnfreezeExtMemCache()
