...
const PROTOBUF_C__SERVICE_DESCRIPTOR_MAGIC = 0x14159bc3
const PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC = 0x28aaeef9
const PROTOBUF_C__ENUM_DESCRIPTOR_MAGIC = 0x114315af
const PROTOBUF_C_VERSION = "1.4.1"
const PROTOBUF_C_VERSION_NUMBER = 1004001
const PROTOBUF_C_MIN_COMPILER_VERSION = 1000000
...
type ProtobufCFieldFlag c.Int

const (
	PROTOBUF_C_FIELD_FLAG_PACKED     ProtobufCFieldFlag = 1
	PROTOBUF_C_FIELD_FLAG_DEPRECATED ProtobufCFieldFlag = 2
	PROTOBUF_C_FIELD_FLAG_ONEOF      ProtobufCFieldFlag = 4
)

type ProtobufCLabel c.Int

const (
	PROTOBUF_C_LABEL_REQUIRED ProtobufCLabel = 0
	PROTOBUF_C_LABEL_OPTIONAL ProtobufCLabel = 1
	PROTOBUF_C_LABEL_REPEATED ProtobufCLabel = 2
	PROTOBUF_C_LABEL_NONE     ProtobufCLabel = 3
)

type ProtobufCType c.Int

const (
	PROTOBUF_C_TYPE_INT32    ProtobufCType = 0
	PROTOBUF_C_TYPE_SINT32   ProtobufCType = 1
	PROTOBUF_C_TYPE_SFIXED32 ProtobufCType = 2
	PROTOBUF_C_TYPE_INT64    ProtobufCType = 3
	PROTOBUF_C_TYPE_SINT64   ProtobufCType = 4
	PROTOBUF_C_TYPE_SFIXED64 ProtobufCType = 5
	PROTOBUF_C_TYPE_UINT32   ProtobufCType = 6
	PROTOBUF_C_TYPE_FIXED32  ProtobufCType = 7
	PROTOBUF_C_TYPE_UINT64   ProtobufCType = 8
	PROTOBUF_C_TYPE_FIXED64  ProtobufCType = 9
	PROTOBUF_C_TYPE_FLOAT    ProtobufCType = 10
	PROTOBUF_C_TYPE_DOUBLE   ProtobufCType = 11
	PROTOBUF_C_TYPE_BOOL     ProtobufCType = 12
	PROTOBUF_C_TYPE_ENUM     ProtobufCType = 13
	PROTOBUF_C_TYPE_STRING   ProtobufCType = 14
	PROTOBUF_C_TYPE_BYTES    ProtobufCType = 15
	PROTOBUF_C_TYPE_MESSAGE  ProtobufCType = 16
)

type ProtobufCWireType c.Int

const (
	PROTOBUF_C_WIRE_TYPE_VARINT          ProtobufCWireType = 0
	PROTOBUF_C_WIRE_TYPE_64BIT           ProtobufCWireType = 1
	PROTOBUF_C_WIRE_TYPE_LENGTH_PREFIXED ProtobufCWireType = 2
	PROTOBUF_C_WIRE_TYPE_32BIT           ProtobufCWireType = 5
)

type ProtobufCAllocator struct {
	Unused [8]uint8
}

type ProtobufCBinaryData struct {
	Unused [8]uint8
}

type ProtobufCBuffer struct {
	Unused [8]uint8
}

type ProtobufCBufferSimple struct {
	Unused [8]uint8
}

type ProtobufCEnumDescriptor struct {
	Unused [8]uint8
}

type ProtobufCEnumValue struct {
	Unused [8]uint8
}

type ProtobufCEnumValueIndex struct {
	Unused [8]uint8
}

type ProtobufCFieldDescriptor struct {
	Unused [8]uint8
}

type ProtobufCIntRange struct {
	Unused [8]uint8
}

type ProtobufCMessage struct {
	Unused [8]uint8
}

type ProtobufCMessageDescriptor struct {
	Unused [8]uint8
}

type ProtobufCMessageUnknownField struct {
	Unused [8]uint8
}

type ProtobufCMethodDescriptor struct {
	Unused [8]uint8
}

type ProtobufCService struct {
	Unused [8]uint8
}

type ProtobufCServiceDescriptor struct {
	Unused [8]uint8
}
type ProtobufCBoolean c.Int

// llgo:type C
type ProtobufCClosure func(*ProtobufCMessage, c.Pointer)

// llgo:type C
type ProtobufCMessageInit func(*ProtobufCMessage)

// llgo:type C
type ProtobufCServiceDestroy func(*ProtobufCService)
