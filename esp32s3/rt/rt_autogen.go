...
const (
	X_CLOCK_REALTIME             ClockidT = 0
	X_CLOCK_MONOTONIC            ClockidT = 6
	X_CLOCK_MONOTONIC_RAW        ClockidT = 4
	X_CLOCK_MONOTONIC_RAW_APPROX ClockidT = 5
	X_CLOCK_UPTIME_RAW           ClockidT = 8
	X_CLOCK_UPTIME_RAW_APPROX    ClockidT = 9
	X_CLOCK_PROCESS_CPUTIME_ID   ClockidT = 12
	X_CLOCK_THREAD_CPUTIME_ID    ClockidT = 16
)
