...
const X_PC_LINK_MAX = 1
const X_PC_MAX_CANON = 2
const X_PC_MAX_INPUT = 3
const X_PC_NAME_MAX = 4
const X_PC_PATH_MAX = 5
const X_PC_PIPE_BUF = 6
const X_PC_CHOWN_RESTRICTED = 7
const X_PC_NO_TRUNC = 8
const X_PC_VDISABLE = 9
const X_PC_NAME_CHARS_MAX = 10
const X_PC_CASE_SENSITIVE = 11
const X_PC_CASE_PRESERVING = 12
const X_PC_EXTENDED_SECURITY_NP = 13
const X_PC_AUTH_OPAQUE_NP = 14
const X_PC_2_SYMLINKS = 15
const X_PC_ALLOC_SIZE_MIN = 16
const X_PC_ASYNC_IO = 17
const X_PC_FILESIZEBITS = 18
const X_PC_PRIO_IO = 19
const X_PC_REC_INCR_XFER_SIZE = 20
const X_PC_REC_MAX_XFER_SIZE = 21
const X_PC_REC_MIN_XFER_SIZE = 22
const X_PC_REC_XFER_ALIGN = 23
const X_PC_SYMLINK_MAX = 24
const X_PC_SYNC_IO = 25
const X_PC_XATTR_SIZE_BITS = 26
...
const X_SC_COLL_WEIGHTS_MAX = 13
...
const X_SC_ASYNCHRONOUS_IO = 28
const X_SC_PAGESIZE = 29
const X_SC_MEMLOCK = 30
const X_SC_MEMLOCK_RANGE = 31
const X_SC_MEMORY_PROTECTION = 32
const X_SC_MESSAGE_PASSING = 33
const X_SC_PRIORITIZED_IO = 34
const X_SC_PRIORITY_SCHEDULING = 35
const X_SC_REALTIME_SIGNALS = 36
const X_SC_SEMAPHORES = 37
const X_SC_FSYNC = 38
const X_SC_SHARED_MEMORY_OBJECTS = 39
const X_SC_SYNCHRONIZED_IO = 40
const X_SC_TIMERS = 41
const X_SC_AIO_LISTIO_MAX = 42
const X_SC_AIO_MAX = 43
const X_SC_AIO_PRIO_DELTA_MAX = 44
const X_SC_DELAYTIMER_MAX = 45
...
const X_SC_NPROCESSORS_CONF = 57
const X_SC_NPROCESSORS_ONLN = 58
const X_SC_2_PBS = 59
const X_SC_2_PBS_ACCOUNTING = 60
const X_SC_2_PBS_CHECKPOINT = 61
...
const X_SC_CLOCK_SELECTION = 67
const X_SC_CPUTIME = 68
const X_SC_FILE_LOCKING = 69
const X_SC_GETGR_R_SIZE_MAX = 70
const X_SC_GETPW_R_SIZE_MAX = 71
const X_SC_HOST_NAME_MAX = 72
const X_SC_LOGIN_NAME_MAX = 73
const X_SC_MONOTONIC_CLOCK = 74
const X_SC_MQ_PRIO_MAX = 75
const X_SC_READER_WRITER_LOCKS = 76
const X_SC_REGEXP = 77
const X_SC_SHELL = 78
const X_SC_SPAWN = 79
const X_SC_SPIN_LOCKS = 80
const X_SC_SPORADIC_SERVER = 81
const X_SC_THREAD_ATTR_STACKADDR = 82
const X_SC_THREAD_ATTR_STACKSIZE = 83
const X_SC_THREAD_CPUTIME = 84
const X_SC_THREAD_DESTRUCTOR_ITERATIONS = 85
const X_SC_THREAD_KEYS_MAX = 86
const X_SC_THREAD_PRIO_INHERIT = 87
const X_SC_THREAD_PRIO_PROTECT = 88
const X_SC_THREAD_PRIORITY_SCHEDULING = 89
const X_SC_THREAD_PROCESS_SHARED = 90
const X_SC_THREAD_SAFE_FUNCTIONS = 91
const X_SC_THREAD_SPORADIC_SERVER = 92
const X_SC_THREAD_STACK_MIN = 93
const X_SC_THREAD_THREADS_MAX = 94
const X_SC_TIMEOUTS = 95
const X_SC_THREADS = 96
const X_SC_TRACE = 97
const X_SC_TRACE_EVENT_FILTER = 98
const X_SC_TRACE_INHERIT = 99
const X_SC_TRACE_LOG = 100
const X_SC_TTY_NAME_MAX = 101
const X_SC_TYPED_MEMORY_OBJECTS = 102
const X_SC_V6_ILP32_OFF32 = 103
const X_SC_V6_ILP32_OFFBIG = 104
const X_SC_V6_LP64_OFF64 = 105
const X_SC_V6_LPBIG_OFFBIG = 106
const X_SC_IPV6 = 118
...
const X_SC_XOPEN_REALTIME_THREADS = 112
const X_SC_XOPEN_SHM = 113
const X_SC_XOPEN_STREAMS = 114
const X_SC_XOPEN_UNIX = 115
const X_SC_XOPEN_VERSION = 116
const X_SC_XOPEN_XCU_VERSION = 121
const X_SC_XBS5_ILP32_OFF32 = 122
const X_SC_XBS5_ILP32_OFFBIG = 123
const X_SC_XBS5_LP64_OFF64 = 124
const X_SC_XBS5_LPBIG_OFFBIG = 125
const X_SC_SS_REPL_MAX = 126
const X_SC_TRACE_EVENT_NAME_MAX = 127
const X_SC_TRACE_NAME_MAX = 128
const X_SC_TRACE_SYS_MAX = 129
const X_SC_TRACE_USER_EVENT_MAX = 130
const X_SC_PASS_MAX = 131
const X_SC_PHYS_PAGES = 200
const X_CS_POSIX_V6_ILP32_OFF32_CFLAGS = 2
const X_CS_POSIX_V6_ILP32_OFF32_LDFLAGS = 3
const X_CS_POSIX_V6_ILP32_OFF32_LIBS = 4
const X_CS_POSIX_V6_ILP32_OFFBIG_CFLAGS = 5
const X_CS_POSIX_V6_ILP32_OFFBIG_LDFLAGS = 6
const X_CS_POSIX_V6_ILP32_OFFBIG_LIBS = 7
const X_CS_POSIX_V6_LP64_OFF64_CFLAGS = 8
const X_CS_POSIX_V6_LP64_OFF64_LDFLAGS = 9
const X_CS_POSIX_V6_LP64_OFF64_LIBS = 10
const X_CS_POSIX_V6_LPBIG_OFFBIG_CFLAGS = 11
const X_CS_POSIX_V6_LPBIG_OFFBIG_LDFLAGS = 12
const X_CS_POSIX_V6_LPBIG_OFFBIG_LIBS = 13
const X_CS_POSIX_V6_WIDTH_RESTRICTED_ENVS = 14
const X_CS_XBS5_ILP32_OFF32_CFLAGS = 20
const X_CS_XBS5_ILP32_OFF32_LDFLAGS = 21
const X_CS_XBS5_ILP32_OFF32_LIBS = 22
const X_CS_XBS5_ILP32_OFF32_LINTFLAGS = 23
const X_CS_XBS5_ILP32_OFFBIG_CFLAGS = 24
const X_CS_XBS5_ILP32_OFFBIG_LDFLAGS = 25
const X_CS_XBS5_ILP32_OFFBIG_LIBS = 26
const X_CS_XBS5_ILP32_OFFBIG_LINTFLAGS = 27
const X_CS_XBS5_LP64_OFF64_CFLAGS = 28
const X_CS_XBS5_LP64_OFF64_LDFLAGS = 29
const X_CS_XBS5_LP64_OFF64_LIBS = 30
const X_CS_XBS5_LP64_OFF64_LINTFLAGS = 31
const X_CS_XBS5_LPBIG_OFFBIG_CFLAGS = 32
const X_CS_XBS5_LPBIG_OFFBIG_LDFLAGS = 33
const X_CS_XBS5_LPBIG_OFFBIG_LIBS = 34
const X_CS_XBS5_LPBIG_OFFBIG_LINTFLAGS = 35
const X_CS_DARWIN_USER_DIR = 65536
const X_CS_DARWIN_USER_TEMP_DIR = 65537
const X_CS_DARWIN_USER_CACHE_DIR = 65538
const F_ULOCK = 0
const F_LOCK = 1
const F_TLOCK = 2
const F_TEST = 3
