...
const (
	...
	RMT_CHANNEL_4   RmtChannelT = 4
	RMT_CHANNEL_5   RmtChannelT = 5
	RMT_CHANNEL_6   RmtChannelT = 6
	RMT_CHANNEL_7   RmtChannelT = 7
	RMT_CHANNEL_MAX RmtChannelT = 8
)
...
type RmtSourceClkT SocPeriphRmtClkSrcLegacyT
