 ...
 */
//go:linkname SpiTimingGetFlashTimingParam C.spi_timing_get_flash_timing_param
func SpiTimingGetFlashTimingParam(out_timing_config *SpiFlashHalTimingConfigT)

/**
 * @brief Get the knowledge if the Flash timing is tuned or not
 */
//go:linkname SpiFlashTimingIsTuned C.spi_flash_timing_is_tuned
func SpiFlashTimingIsTuned() bool
 ...
 */
//go:linkname SpiFlashEnableHighPerformanceMode C.spi_flash_enable_high_performance_mode
func SpiFlashEnableHighPerformanceMode() EspErrT
 ...
 */
//go:linkname SpiFlashHpmGetDummy C.spi_flash_hpm_get_dummy
func SpiFlashHpmGetDummy() *SpiFlashHpmDummyConfT
 ...
 */
//go:linkname SpiFlashHpmDummyAdjust C.spi_flash_hpm_dummy_adjust
func SpiFlashHpmDummyAdjust() bool
