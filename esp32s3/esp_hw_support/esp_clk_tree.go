 ...
 */
//go:linkname EspClkTreeSrcGetFreqHz C.esp_clk_tree_src_get_freq_hz
func EspClkTreeSrcGetFreqHz(clk_src SocModuleClkT, precision EspClkTreeSrcFreqPrecisionT, freq_value *c.Uint32T) EspErrT
