 ...
 */
//go:linkname EspMprotLlErrToEspErr C.esp_mprot_ll_err_to_esp_err
func EspMprotLlErrToEspErr(err MemprotHalErrT) EspErrT

/**
 * @brief Convert Memprot low level PMS World IDs to esp_mprot_pms_world_t
 */
//go:linkname EspMprotLlWorldToHlWorld C.esp_mprot_ll_world_to_hl_world
func EspMprotLlWorldToHlWorld(world MemprotHalWorldT) EspMprotPmsWorldT
