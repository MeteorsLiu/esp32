...
const SOC_DELAY_RC32K_ENABLE = 300
const SOC_DELAY_LP_PLL_SWITCH = 3
const SOC_DELAY_LP_PLL_ENABLE = 50
const RTC_CNTL_PLL_BUF_WAIT_DEFAULT = 20
const RTC_CNTL_XTL_BUF_WAIT_DEFAULT = 100
const RTC_CNTL_CK8M_DFREQ_DEFAULT = 860
const RTC_CNTL_SCK_DCAP_DEFAULT = 85
...
const (
	RTC_CAL_RTC_MUX      RtcCalSelT = -1
	RTC_CAL_RC_SLOW      RtcCalSelT = 0
	RTC_CAL_RC32K        RtcCalSelT = 2
	RTC_CAL_32K_XTAL     RtcCalSelT = 1
	RTC_CAL_32K_OSC_SLOW RtcCalSelT = 3
	RTC_CAL_RC_FAST      RtcCalSelT = 4
)
