 ...
 * @return : ESP_OK - success, other - failed
 */
// llgo:link EspCoexStatusTypeT.EspCoexStatusBitSet C.esp_coex_status_bit_set
func (recv_ EspCoexStatusTypeT) EspCoexStatusBitSet(status c.Uint32T) EspErrT {
	return 0
}
 ...
 * @return : ESP_OK - success, other - failed
 */
// llgo:link EspCoexStatusTypeT.EspCoexStatusBitClear C.esp_coex_status_bit_clear
func (recv_ EspCoexStatusTypeT) EspCoexStatusBitClear(status c.Uint32T) EspErrT {
	return 0
}
