...
type EfuseRdMacSys0RegT struct {
	Val c.Uint32T
}
...
type EfuseRdMacSys1RegT struct {
	Val c.Uint32T
}
...
type EfuseRdMacSys2RegT struct {
	Val c.Uint32T
}
...
type EfuseRdMacSys3RegT struct {
	Val c.Uint32T
}
...
type EfuseRdMacSys4RegT struct {
	Val c.Uint32T
}
...
type EfuseRdMacSys5RegT struct {
	Val c.Uint32T
}
...
type EfuseDevT struct {
	...
	RdMacSys0          EfuseRdMacSys0RegT
	RdMacSys1          EfuseRdMacSys1RegT
	RdMacSys2          EfuseRdMacSys2RegT
	RdMacSys3          EfuseRdMacSys3RegT
	RdMacSys4          EfuseRdMacSys4RegT
	RdMacSys5          EfuseRdMacSys5RegT
