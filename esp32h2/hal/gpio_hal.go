 ...
 */
// llgo:link (*GpioHalContextT).GpioHalHysteresisSoftEnable C.gpio_hal_hysteresis_soft_enable
func (recv_ *GpioHalContextT) GpioHalHysteresisSoftEnable(gpio_num c.Uint32T, enable bool) {
}
