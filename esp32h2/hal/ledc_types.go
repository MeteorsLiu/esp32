...
const (
	LEDC_SLOW_CLK_RC_FAST LedcSlowClkSelT = 8
	LEDC_SLOW_CLK_PLL_DIV LedcSlowClkSelT = 6
	LEDC_SLOW_CLK_XTAL    LedcSlowClkSelT = 9
	LEDC_SLOW_CLK_RTC8M   LedcSlowClkSelT = 8
)

type LedcClkCfgT SocPeriphLedcClkSrcLegacyT
type LedcClkSrcT c.Int

const LEDC_SCLK LedcClkSrcT = 6
...
const (
	...
	LEDC_CHANNEL_MAX LedcChannelT = 6
)
...
const (
	...
	LEDC_TIMER_15_BIT  LedcTimerBitT = 15
	LEDC_TIMER_16_BIT  LedcTimerBitT = 16
	LEDC_TIMER_17_BIT  LedcTimerBitT = 17
	LEDC_TIMER_18_BIT  LedcTimerBitT = 18
	LEDC_TIMER_19_BIT  LedcTimerBitT = 19
	LEDC_TIMER_20_BIT  LedcTimerBitT = 20
	LEDC_TIMER_BIT_MAX LedcTimerBitT = 21
)
