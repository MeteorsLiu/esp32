 ...
 */
//go:linkname AesHalEnablePseudoRounds C.aes_hal_enable_pseudo_rounds
func AesHalEnablePseudoRounds(enable bool, base c.Uint8T, increment c.Uint8T, key_rng_cnt c.Uint8T)
