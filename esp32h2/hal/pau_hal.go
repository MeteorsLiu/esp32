 ...
 */
// llgo:link (*PauHalContextT).PauHalStartRegdmaSystemLink C.pau_hal_start_regdma_system_link
func (recv_ *PauHalContextT) PauHalStartRegdmaSystemLink(backup_or_restore bool) {
}
 ...
 * @param hal           regdma hal context
 */
// llgo:link (*PauHalContextT).PauHalStopRegdmaSystemLink C.pau_hal_stop_regdma_system_link
func (recv_ *PauHalContextT) PauHalStopRegdmaSystemLink() {
}
 ...
 * @param hal           regdma hal context
 */
// llgo:link (*PauHalContextT).PauHalRegdmaClockConfigure C.pau_hal_regdma_clock_configure
func (recv_ *PauHalContextT) PauHalRegdmaClockConfigure(enable bool) {
}
