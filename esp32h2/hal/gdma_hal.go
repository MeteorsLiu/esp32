...
// llgo:link (*GdmaHalContextT).GdmaHalEnableEtmTask C.gdma_hal_enable_etm_task
func (recv_ *GdmaHalContextT) GdmaHalEnableEtmTask(chan_id c.Int, dir GdmaChannelDirectionT, en_or_dis bool) {
}
