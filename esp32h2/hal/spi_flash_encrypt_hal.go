...
const XTS_AES_PSEUDO_ROUNDS_BASE = 4
const XTS_AES_PSEUDO_ROUNDS_INC = 2
const XTS_AES_PSEUDO_ROUNDS_RNG_CNT = 7

type EspXtsAesPsuedoRoundsStateT c.Int

const (
	ESP_XTS_AES_PSEUDO_ROUNDS_DISABLE EspXtsAesPsuedoRoundsStateT = 0
	ESP_XTS_AES_PSEUDO_ROUNDS_LOW     EspXtsAesPsuedoRoundsStateT = 1
	ESP_XTS_AES_PSEUDO_ROUNDS_MEDIUM  EspXtsAesPsuedoRoundsStateT = 2
	ESP_XTS_AES_PSEUDO_ROUNDS_HIGH    EspXtsAesPsuedoRoundsStateT = 3
)
 ...
 */
//go:linkname SpiFlashEncryptionHalEnablePseudoRounds C.spi_flash_encryption_hal_enable_pseudo_rounds
func SpiFlashEncryptionHalEnablePseudoRounds(mode c.Uint8T, base c.Uint8T, increment c.Uint8T, key_rng_cnt c.Uint8T)
