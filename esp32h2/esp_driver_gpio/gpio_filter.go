 ...
 */
// llgo:link (*GpioPinGlitchFilterConfigT).GpioNewPinGlitchFilter C.gpio_new_pin_glitch_filter
func (recv_ *GpioPinGlitchFilterConfigT) GpioNewPinGlitchFilter(ret_filter *GpioGlitchFilterHandleT) EspErrT {
	return 0
}
 ...
 */
// llgo:link (*GpioFlexGlitchFilterConfigT).GpioNewFlexGlitchFilter C.gpio_new_flex_glitch_filter
func (recv_ *GpioFlexGlitchFilterConfigT) GpioNewFlexGlitchFilter(ret_filter *GpioGlitchFilterHandleT) EspErrT {
	return 0
}
