...
func XTimerCreateStatic(pcTimerName *c.Char, xTimerPeriodInTicks TickTypeT, xAutoReload BaseTypeT, pvTimerID c.Pointer, pxCallbackFunction TimerCallbackFunctionT, pxTimerBuffer *c.Int) TimerHandleT
...
func XTimerIsTimerActive(xTimer TimerHandleT) c.Int
...
func XTimerPendFunctionCallFromISR(xFunctionToPend PendedFunctionT, pvParameter1 c.Pointer, ulParameter2 c.Uint32T, pxHigherPriorityTaskWoken BaseTypeT) c.Int
...
func XTimerPendFunctionCall(xFunctionToPend PendedFunctionT, pvParameter1 c.Pointer, ulParameter2 c.Uint32T, xTicksToWait TickTypeT) c.Int
...
func XTimerGetReloadMode(xTimer TimerHandleT) c.Int
...
func XTimerGetStaticBuffer(xTimer TimerHandleT, ppxTimerBuffer **c.Int) c.Int
...
func XTimerCreateTimerTask() c.Int

//go:linkname XTimerGenericCommand C.xTimerGenericCommand
func XTimerGenericCommand(xTimer TimerHandleT, xCommandID BaseTypeT, xOptionalValue TickTypeT, pxHigherPriorityTaskWoken BaseTypeT, xTicksToWait TickTypeT) c.Int
...
func VApplicationGetTimerTaskMemory(ppxTimerTaskTCBBuffer **c.Int, ppxTimerTaskStackBuffer **StackTypeT, pulTimerTaskStackSize *c.Uint32T)
