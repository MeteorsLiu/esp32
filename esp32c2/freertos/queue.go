...
func XQueueGenericSend(xQueue QueueHandleT, pvItemToQueue c.Pointer, xTicksToWait TickTypeT, xCopyPosition BaseTypeT) c.Int
...
func XQueuePeek(xQueue QueueHandleT, pvBuffer c.Pointer, xTicksToWait TickTypeT) c.Int
...
func XQueuePeekFromISR(xQueue QueueHandleT, pvBuffer c.Pointer) c.Int
...
func XQueueReceive(xQueue QueueHandleT, pvBuffer c.Pointer, xTicksToWait TickTypeT) c.Int
...
func XQueueGenericSendFromISR(xQueue QueueHandleT, pvItemToQueue c.Pointer, pxHigherPriorityTaskWoken BaseTypeT, xCopyPosition BaseTypeT) c.Int

//go:linkname XQueueGiveFromISR C.xQueueGiveFromISR
func XQueueGiveFromISR(xQueue QueueHandleT, pxHigherPriorityTaskWoken BaseTypeT) c.Int
...
func XQueueReceiveFromISR(xQueue QueueHandleT, pvBuffer c.Pointer, pxHigherPriorityTaskWoken BaseTypeT) c.Int
...
func XQueueIsQueueEmptyFromISR(xQueue QueueHandleT) c.Int
...
func XQueueIsQueueFullFromISR(xQueue QueueHandleT) c.Int
...
func XQueueCreateMutexStatic(ucQueueType c.Uint8T, pxStaticQueue *c.Int) QueueHandleT
...
func (recv_ UBaseTypeT) XQueueCreateCountingSemaphoreStatic(uxInitialCount UBaseTypeT, pxStaticQueue *c.Int) QueueHandleT {
	return nil
}

//go:linkname XQueueSemaphoreTake C.xQueueSemaphoreTake
func XQueueSemaphoreTake(xQueue QueueHandleT, xTicksToWait TickTypeT) c.Int
...
func XQueueTakeMutexRecursive(xMutex QueueHandleT, xTicksToWait TickTypeT) c.Int

//go:linkname XQueueGiveMutexRecursive C.xQueueGiveMutexRecursive
func XQueueGiveMutexRecursive(xMutex QueueHandleT) c.Int
...
func (recv_ UBaseTypeT) XQueueGenericCreateStatic(uxItemSize UBaseTypeT, pucQueueStorage *c.Uint8T, pxStaticQueue *c.Int, ucQueueType c.Uint8T) QueueHandleT {
	return nil
}
...
func XQueueGenericGetStaticBuffers(xQueue QueueHandleT, ppucQueueStorage **c.Uint8T, ppxStaticQueue **c.Int) c.Int
...
func XQueueAddToSet(xQueueOrSemaphore QueueSetMemberHandleT, xQueueSet QueueSetHandleT) c.Int
...
func XQueueRemoveFromSet(xQueueOrSemaphore QueueSetMemberHandleT, xQueueSet QueueSetHandleT) c.Int
...
func XQueueGenericReset(xQueue QueueHandleT, xNewQueue BaseTypeT) c.Int
