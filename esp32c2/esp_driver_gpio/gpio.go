 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
//go:linkname GpioDeepSleepWakeupEnable C.gpio_deep_sleep_wakeup_enable
func GpioDeepSleepWakeupEnable(gpio_num GpioNumT, intr_type GpioIntTypeT) EspErrT
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
//go:linkname GpioDeepSleepWakeupDisable C.gpio_deep_sleep_wakeup_disable
func GpioDeepSleepWakeupDisable(gpio_num GpioNumT) EspErrT
