...
const (
	...
	ESP_TIMER_ISR  EspTimerDispatchT = 1
	ESP_TIMER_MAX  EspTimerDispatchT = 2
)
 ...
 */
//go:linkname EspTimerIsrDispatchNeedYield C.esp_timer_isr_dispatch_need_yield
func EspTimerIsrDispatchNeedYield()
