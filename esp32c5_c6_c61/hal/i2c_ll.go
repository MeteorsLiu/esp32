...
const LP_I2C_SCL_PIN_ERR_LOG = "SCL pin can only be configured as GPIO#7"
const LP_I2C_SDA_PIN_ERR_LOG = "SDA pin can only be configured as GPIO#6"
const LP_I2C_SDA_IOMUX_PAD = 6
const LP_I2C_SCL_IOMUX_PAD = 7
...
const (
	...
	I2C_INTR_UNMATCH       I2cLlSlaveIntrT = 262144
)
