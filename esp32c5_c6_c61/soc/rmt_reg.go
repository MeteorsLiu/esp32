...
const RMT_RMT_RX_LIM_CH2_S = 0
const RMT_APB_FIFO_MASK_S = 0
const RMT_MEM_CLK_FORCE_ON_S = 1
const RMT_RMT_MEM_FORCE_PD_S = 2
const RMT_RMT_MEM_FORCE_PU_S = 3
const RMT_RMT_SCLK_DIV_NUM_S = 4
const RMT_RMT_SCLK_DIV_A_S = 12
const RMT_RMT_SCLK_DIV_B_S = 18
const RMT_RMT_SCLK_SEL_S = 24
const RMT_RMT_SCLK_ACTIVE_S = 26
