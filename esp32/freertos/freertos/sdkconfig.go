...
const CONFIG_IDF_TOOLCHAIN = "clang"
const CONFIG_IDF_TOOLCHAIN_CLANG = 1
...
const CONFIG_COMPILER_RT_LIB_CLANGRT = 1
const CONFIG_COMPILER_RT_LIB_NAME = "clang_rt.builtins"
