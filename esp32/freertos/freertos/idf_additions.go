...
func XTaskCreatePinnedToCore(pxTaskCode TaskFunctionT, pcName *c.Char, ulStackDepth c.Uint32T, pvParameters c.Pointer, uxPriority UBaseTypeT, pxCreatedTask *TaskHandleT, xCoreID BaseTypeT) c.Int
...
func XTaskCreateStaticPinnedToCore(pxTaskCode TaskFunctionT, pcName *c.Char, ulStackDepth c.Uint32T, pvParameters c.Pointer, uxPriority UBaseTypeT, puxStackBuffer *StackTypeT, pxTaskBuffer *c.Int, xCoreID BaseTypeT) TaskHandleT
...
func XTaskCreatePinnedToCoreWithCaps(pvTaskCode TaskFunctionT, pcName *c.Char, usStackDepth c.Uint32T, pvParameters c.Pointer, uxPriority UBaseTypeT, pvCreatedTask *TaskHandleT, xCoreID BaseTypeT, uxMemoryCaps UBaseTypeT) c.Int
