...
type TwaiHalContextT struct {
	...
	TxFrameSave   TwaiHalFrameT
	RegSave       TwaiLlRegSaveT
	RxMsgCntSave  c.Uint8T
}
 ...
 * @param hal_ctx Context of the HAL layer
 */
// llgo:link (*TwaiHalContextT).TwaiHalPrepareForReset C.twai_hal_prepare_for_reset
func (recv_ *TwaiHalContextT) TwaiHalPrepareForReset() {
}
 ...
 * @param hal_ctx Context of the HAL layer
 */
// llgo:link (*TwaiHalContextT).TwaiHalRecoverFromReset C.twai_hal_recover_from_reset
func (recv_ *TwaiHalContextT) TwaiHalRecoverFromReset() {
}
