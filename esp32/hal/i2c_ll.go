...
const I2C_LL_CMD_RESTART = 0
const I2C_LL_CMD_WRITE = 1
const I2C_LL_CMD_READ = 2
const I2C_LL_CMD_STOP = 3
...
const (
	...
	I2C_INTR_MST_RXFIFO_WM   I2cLlMasterIntrT = 2048
...
const (
	...
	I2C_INTR_SLV_RXFIFO_WM I2cLlSlaveIntrT = 2048
