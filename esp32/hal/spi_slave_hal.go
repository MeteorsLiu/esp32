 ...
 */
//go:linkname SpiSlaveHalHwPrepareRx C.spi_slave_hal_hw_prepare_rx
func SpiSlaveHalHwPrepareRx(hw *SpiDevT)
 ...
 * @param hw Beginning address of the peripheral registers.
 */
//go:linkname SpiSlaveHalHwPrepareTx C.spi_slave_hal_hw_prepare_tx
func SpiSlaveHalHwPrepareTx(hw *SpiDevT)
 ...
 */
// llgo:link (*SpiSlaveHalContextT).SpiSlaveHalDmaNeedReset C.spi_slave_hal_dma_need_reset
func (recv_ *SpiSlaveHalContextT) SpiSlaveHalDmaNeedReset() bool {
	return false
}
