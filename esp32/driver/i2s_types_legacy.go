...
const (
	...
	I2S_MODE_DAC_BUILT_IN I2sModeT = 16
	I2S_MODE_ADC_BUILT_IN I2sModeT = 32
	I2S_MODE_PDM          I2sModeT = 64
)

type I2sDacModeT c.Int

const (
	I2S_DAC_CHANNEL_DISABLE  I2sDacModeT = 0
	I2S_DAC_CHANNEL_RIGHT_EN I2sDacModeT = 1
	I2S_DAC_CHANNEL_LEFT_EN  I2sDacModeT = 2
	I2S_DAC_CHANNEL_BOTH_EN  I2sDacModeT = 3
	I2S_DAC_CHANNEL_MAX      I2sDacModeT = 4
)
