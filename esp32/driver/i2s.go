 ...
 */
//go:linkname I2sSetPdmRxDownSample C.i2s_set_pdm_rx_down_sample
func I2sSetPdmRxDownSample(i2s_num I2sPortT, downsample I2sPdmDsrT) EspErrT
 ...
 *     - ESP_ERR_NO_MEM      Out of memory
 */
//go:linkname I2sSetPdmTxUpSample C.i2s_set_pdm_tx_up_sample
func I2sSetPdmTxUpSample(i2s_num I2sPortT, upsample_cfg *I2sPdmTxUpsampleCfgT) EspErrT
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
//go:linkname I2sSetAdcMode C.i2s_set_adc_mode
func I2sSetAdcMode(adc_unit AdcUnitT, adc_channel Adc1ChannelT) EspErrT
 ...
 */
//go:linkname I2sAdcEnable C.i2s_adc_enable
func I2sAdcEnable(i2s_num I2sPortT) EspErrT
 ...
 *     - ESP_ERR_INVALID_STATE  Driver state error
 */
//go:linkname I2sAdcDisable C.i2s_adc_disable
func I2sAdcDisable(i2s_num I2sPortT) EspErrT
 ...
 *     - ESP_ERR_INVALID_ARG  Parameter error
 */
// llgo:link I2sDacModeT.I2sSetDacMode C.i2s_set_dac_mode
func (recv_ I2sDacModeT) I2sSetDacMode() EspErrT {
	return 0
}
