...
func XTaskCreatePinnedToCoreWithCaps(pvTaskCode c.Int, pcName *c.Char, usStackDepth c.Uint32T, pvParameters c.Pointer, uxPriority UBaseTypeT, pvCreatedTask *TaskHandleT, xCoreID BaseTypeT, uxMemoryCaps UBaseTypeT) c.Int
