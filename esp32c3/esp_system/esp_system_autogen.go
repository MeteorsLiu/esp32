...
type ExecutionFrame RvExcFrame
type RiscvRegnumT c.Int

const (
	UNW_RISCV_PC      RiscvRegnumT = 0
	UNW_RISCV_RA      RiscvRegnumT = 1
	UNW_RISCV_SP      RiscvRegnumT = 2
	UNW_RISCV_GP      RiscvRegnumT = 3
	UNW_RISCV_TP      RiscvRegnumT = 4
	UNW_RISCV_T0      RiscvRegnumT = 5
	UNW_RISCV_T1      RiscvRegnumT = 6
	UNW_RISCV_T2      RiscvRegnumT = 7
	UNW_RISCV_S0      RiscvRegnumT = 8
	UNW_RISCV_S1      RiscvRegnumT = 9
	UNW_RISCV_A0      RiscvRegnumT = 10
	UNW_RISCV_A1      RiscvRegnumT = 11
	UNW_RISCV_A2      RiscvRegnumT = 12
	UNW_RISCV_A3      RiscvRegnumT = 13
	UNW_RISCV_A4      RiscvRegnumT = 14
	UNW_RISCV_A5      RiscvRegnumT = 15
	UNW_RISCV_A6      RiscvRegnumT = 16
	UNW_RISCV_A7      RiscvRegnumT = 17
	UNW_RISCV_S2      RiscvRegnumT = 18
	UNW_RISCV_S3      RiscvRegnumT = 19
	UNW_RISCV_S4      RiscvRegnumT = 20
	UNW_RISCV_S5      RiscvRegnumT = 21
	UNW_RISCV_S6      RiscvRegnumT = 22
	UNW_RISCV_S7      RiscvRegnumT = 23
	UNW_RISCV_S8      RiscvRegnumT = 24
	UNW_RISCV_S9      RiscvRegnumT = 25
	UNW_RISCV_S10     RiscvRegnumT = 26
	UNW_RISCV_S11     RiscvRegnumT = 27
	UNW_RISCV_T3      RiscvRegnumT = 28
	UNW_RISCV_T4      RiscvRegnumT = 29
	UNW_RISCV_T5      RiscvRegnumT = 30
	UNW_RISCV_T6      RiscvRegnumT = 31
	UNW_RISCV_MSTATUS RiscvRegnumT = 32
	UNW_RISCV_MTVEC   RiscvRegnumT = 33
	UNW_RISCV_MCAUSE  RiscvRegnumT = 34
	UNW_RISCV_MTVAL   RiscvRegnumT = 35
	UNW_RISCV_MHARTID RiscvRegnumT = 36
)
