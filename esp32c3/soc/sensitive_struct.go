...
type SensitiveDevS struct {
	...
	RomTable             c.Uint32T
	PrivilegeModeSelLock struct {
		Val c.Uint32T
	}
	PrivilegeModeSel struct {
		Val c.Uint32T
	}
	...
	DmaApbperiUchi0PmsConstrain0 struct {
		Val c.Uint32T
	}
	DmaApbperiUchi0PmsConstrain1 struct {
		Val c.Uint32T
	}
	...
	SensitiveionPmsConstrain0 struct {
		Val c.Uint32T
	}
	SensitiveionPmsConstrain1 struct {
		Val c.Uint32T
	}
	SensitiveionPmsConstrain2 struct {
		Val c.Uint32T
	}
	SensitiveionPmsConstrain3 struct {
		Val c.Uint32T
	}
	SensitiveionPmsConstrain4 struct {
		Val c.Uint32T
	}
	SensitiveionPmsConstrain5 struct {
		Val c.Uint32T
	}
	SensitiveionPmsConstrain6 struct {
		Val c.Uint32T
	}
	SensitiveionPmsConstrain7 struct {
		Val c.Uint32T
	}
	SensitiveionPmsConstrain8 struct {
		Val c.Uint32T
	}
	SensitiveionPmsConstrain9 struct {
		Val c.Uint32T
	}
	SensitiveionPmsConstrain10 struct {
		Val c.Uint32T
	}
