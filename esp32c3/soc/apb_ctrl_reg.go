...
const APB_CTRL_FLASH_ACE0_ATTR = 0x00000003
const APB_CTRL_FLASH_ACE0_ATTR_V = 0x3
const APB_CTRL_FLASH_ACE0_ATTR_S = 0
const APB_CTRL_FLASH_ACE1_ATTR = 0x00000003
const APB_CTRL_FLASH_ACE1_ATTR_V = 0x3
const APB_CTRL_FLASH_ACE1_ATTR_S = 0
const APB_CTRL_FLASH_ACE2_ATTR = 0x00000003
const APB_CTRL_FLASH_ACE2_ATTR_V = 0x3
const APB_CTRL_FLASH_ACE2_ATTR_S = 0
const APB_CTRL_FLASH_ACE3_ATTR = 0x00000003
const APB_CTRL_FLASH_ACE3_ATTR_V = 0x3
...
const APB_CTRL_FLASH_ACE0_SIZE = 0x00001FFF
const APB_CTRL_FLASH_ACE0_SIZE_V = 0x1FFF
const APB_CTRL_FLASH_ACE0_SIZE_S = 0
const APB_CTRL_FLASH_ACE1_SIZE = 0x00001FFF
const APB_CTRL_FLASH_ACE1_SIZE_V = 0x1FFF
const APB_CTRL_FLASH_ACE1_SIZE_S = 0
const APB_CTRL_FLASH_ACE2_SIZE = 0x00001FFF
const APB_CTRL_FLASH_ACE2_SIZE_V = 0x1FFF
const APB_CTRL_FLASH_ACE2_SIZE_S = 0
const APB_CTRL_FLASH_ACE3_SIZE = 0x00001FFF
const APB_CTRL_FLASH_ACE3_SIZE_V = 0x1FFF
...
const APB_CTRL_RETENTION_LINK_ADDR = 0x07FFFFFF
const APB_CTRL_RETENTION_LINK_ADDR_V = 0x7FFFFFF
const APB_CTRL_RETENTION_LINK_ADDR_S = 0
const APB_CTRL_SRAM_CLKGATE_FORCE_ON = 0x0000000F
const APB_CTRL_SRAM_CLKGATE_FORCE_ON_V = 0xF
const APB_CTRL_SRAM_CLKGATE_FORCE_ON_S = 2
const APB_CTRL_ROM_CLKGATE_FORCE_ON = 0x00000003
const APB_CTRL_ROM_CLKGATE_FORCE_ON_V = 0x3
const APB_CTRL_ROM_CLKGATE_FORCE_ON_S = 0
const APB_CTRL_SRAM_POWER_DOWN = 0x0000000F
const APB_CTRL_SRAM_POWER_DOWN_V = 0xF
const APB_CTRL_SRAM_POWER_DOWN_S = 2
const APB_CTRL_ROM_POWER_DOWN = 0x00000003
const APB_CTRL_ROM_POWER_DOWN_V = 0x3
const APB_CTRL_ROM_POWER_DOWN_S = 0
const APB_CTRL_SRAM_POWER_UP = 0x0000000F
const APB_CTRL_SRAM_POWER_UP_V = 0xF
const APB_CTRL_SRAM_POWER_UP_S = 2
const APB_CTRL_ROM_POWER_UP = 0x00000003
const APB_CTRL_ROM_POWER_UP_V = 0x3
const APB_CTRL_ROM_POWER_UP_S = 0
const APB_CTRL_RND_DATA = 0xFFFFFFFF
const APB_CTRL_RND_DATA_V = 0xFFFFFFFF
const APB_CTRL_RND_DATA_S = 0
const APB_CTRL_PERI_BACKUP_ENA_V = 0x1
const APB_CTRL_PERI_BACKUP_ENA_S = 31
const APB_CTRL_PERI_BACKUP_TO_MEM_V = 0x1
const APB_CTRL_PERI_BACKUP_TO_MEM_S = 30
const APB_CTRL_PERI_BACKUP_START_V = 0x1
const APB_CTRL_PERI_BACKUP_START_S = 29
const APB_CTRL_PERI_BACKUP_SIZE = 0x000003FF
const APB_CTRL_PERI_BACKUP_SIZE_V = 0x3FF
const APB_CTRL_PERI_BACKUP_SIZE_S = 19
const APB_CTRL_PERI_BACKUP_TOUT_THRES = 0x000003FF
const APB_CTRL_PERI_BACKUP_TOUT_THRES_V = 0x3FF
const APB_CTRL_PERI_BACKUP_TOUT_THRES_S = 9
const APB_CTRL_PERI_BACKUP_BURST_LIMIT = 0x0000001F
const APB_CTRL_PERI_BACKUP_BURST_LIMIT_V = 0x1F
const APB_CTRL_PERI_BACKUP_BURST_LIMIT_S = 4
const APB_CTRL_PERI_BACKUP_FLOW_ERR = 0x00000003
const APB_CTRL_PERI_BACKUP_FLOW_ERR_V = 0x3
const APB_CTRL_PERI_BACKUP_FLOW_ERR_S = 1
const APB_CTRL_BACKUP_APB_START_ADDR = 0xFFFFFFFF
const APB_CTRL_BACKUP_APB_START_ADDR_V = 0xFFFFFFFF
const APB_CTRL_BACKUP_APB_START_ADDR_S = 0
const APB_CTRL_BACKUP_MEM_START_ADDR = 0xFFFFFFFF
const APB_CTRL_BACKUP_MEM_START_ADDR_V = 0xFFFFFFFF
const APB_CTRL_BACKUP_MEM_START_ADDR_S = 0
const APB_CTRL_PERI_BACKUP_ERR_INT_RAW_V = 0x1
const APB_CTRL_PERI_BACKUP_ERR_INT_RAW_S = 1
const APB_CTRL_PERI_BACKUP_DONE_INT_RAW_V = 0x1
const APB_CTRL_PERI_BACKUP_DONE_INT_RAW_S = 0
const APB_CTRL_PERI_BACKUP_ERR_INT_ST_V = 0x1
const APB_CTRL_PERI_BACKUP_ERR_INT_ST_S = 1
const APB_CTRL_PERI_BACKUP_DONE_INT_ST_V = 0x1
const APB_CTRL_PERI_BACKUP_DONE_INT_ST_S = 0
const APB_CTRL_PERI_BACKUP_ERR_INT_ENA_V = 0x1
const APB_CTRL_PERI_BACKUP_ERR_INT_ENA_S = 1
const APB_CTRL_PERI_BACKUP_DONE_INT_ENA_V = 0x1
const APB_CTRL_PERI_BACKUP_DONE_INT_ENA_S = 0
const APB_CTRL_PERI_BACKUP_ERR_INT_CLR_V = 0x1
const APB_CTRL_PERI_BACKUP_ERR_INT_CLR_S = 1
const APB_CTRL_PERI_BACKUP_DONE_INT_CLR_V = 0x1
const APB_CTRL_PERI_BACKUP_DONE_INT_CLR_S = 0
