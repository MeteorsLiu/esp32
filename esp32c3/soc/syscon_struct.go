...
type SysconDevS struct {
	...
	RndData          c.Uint32T
	PeriBackupConfig struct {
		Val c.Uint32T
	}
	PeriBackupApbAddr c.Uint32T
	PeriBackupMemAddr c.Uint32T
	PeriBackupIntRaw  struct {
		Val c.Uint32T
	}
	PeriBackupIntSt struct {
		Val c.Uint32T
	}
	PeriBackupIntEna struct {
		Val c.Uint32T
	}
	ReservedCc       c.Uint32T
	PeriBackupIntClr struct {
		Val c.Uint32T
	}
