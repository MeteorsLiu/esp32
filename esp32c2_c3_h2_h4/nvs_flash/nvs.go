...
const NVS_DEFAULT_PART_NAME = "nvs"
const NVS_PART_NAME_MAX_SIZE = 16
const NVS_KEY_NAME_MAX_SIZE = 16

type NvsHandleT c.Uint32T
type NvsHandle NvsHandleT
type NvsOpenModeT c.Int

const (
	NVS_READONLY  NvsOpenModeT = 0
	NVS_READWRITE NvsOpenModeT = 1
)

type NvsOpenMode NvsOpenModeT
type NvsTypeT c.Int

const (
	NVS_TYPE_U8   NvsTypeT = 1
	NVS_TYPE_I8   NvsTypeT = 17
	NVS_TYPE_U16  NvsTypeT = 2
	NVS_TYPE_I16  NvsTypeT = 18
	NVS_TYPE_U32  NvsTypeT = 4
	NVS_TYPE_I32  NvsTypeT = 20
	NVS_TYPE_U64  NvsTypeT = 8
	NVS_TYPE_I64  NvsTypeT = 24
	NVS_TYPE_STR  NvsTypeT = 33
	NVS_TYPE_BLOB NvsTypeT = 66
	NVS_TYPE_ANY  NvsTypeT = 255
)
...
type NvsEntryInfoT struct {
	NamespaceName [16]c.Char
	Key           [16]c.Char
	Type          NvsTypeT
}

type NvsOpaqueIteratorT struct {
	Unused [8]uint8
}
type NvsIteratorT *NvsOpaqueIteratorT
 ...
 */
//go:linkname NvsOpen C.nvs_open
func NvsOpen(namespace_name *c.Char, open_mode NvsOpenModeT, out_handle *NvsHandleT) EspErrT
 ...
 *             - other error codes from the underlying storage driver
 */
//go:linkname NvsOpenFromPartition C.nvs_open_from_partition
func NvsOpenFromPartition(part_name *c.Char, namespace_name *c.Char, open_mode NvsOpenModeT, out_handle *NvsHandleT) EspErrT
 ...
 */
// llgo:link NvsHandleT.NvsSetI8 C.nvs_set_i8
func (recv_ NvsHandleT) NvsSetI8(key *c.Char, value c.Int8T) EspErrT {
	return 0
}
 ...
 */
// llgo:link NvsHandleT.NvsSetU8 C.nvs_set_u8
func (recv_ NvsHandleT) NvsSetU8(key *c.Char, value c.Uint8T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsSetI16 C.nvs_set_i16
func (recv_ NvsHandleT) NvsSetI16(key *c.Char, value c.Int16T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsSetU16 C.nvs_set_u16
func (recv_ NvsHandleT) NvsSetU16(key *c.Char, value c.Uint16T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsSetI32 C.nvs_set_i32
func (recv_ NvsHandleT) NvsSetI32(key *c.Char, value c.Int32T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsSetU32 C.nvs_set_u32
func (recv_ NvsHandleT) NvsSetU32(key *c.Char, value c.Uint32T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsSetI64 C.nvs_set_i64
func (recv_ NvsHandleT) NvsSetI64(key *c.Char, value c.Int64T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_set_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsSetU64 C.nvs_set_u64
func (recv_ NvsHandleT) NvsSetU64(key *c.Char, value c.Uint64T) EspErrT {
	return 0
}
 ...
 */
// llgo:link NvsHandleT.NvsSetStr C.nvs_set_str
func (recv_ NvsHandleT) NvsSetStr(key *c.Char, value *c.Char) EspErrT {
	return 0
}
 ...
 */
// llgo:link NvsHandleT.NvsSetBlob C.nvs_set_blob
func (recv_ NvsHandleT) NvsSetBlob(key *c.Char, value c.Pointer, length c.SizeT) EspErrT {
	return 0
}
 ...
 */
// llgo:link NvsHandleT.NvsGetI8 C.nvs_get_i8
func (recv_ NvsHandleT) NvsGetI8(key *c.Char, out_value *c.Int8T) EspErrT {
	return 0
}
 ...
 */
// llgo:link NvsHandleT.NvsGetU8 C.nvs_get_u8
func (recv_ NvsHandleT) NvsGetU8(key *c.Char, out_value *c.Uint8T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsGetI16 C.nvs_get_i16
func (recv_ NvsHandleT) NvsGetI16(key *c.Char, out_value *c.Int16T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsGetU16 C.nvs_get_u16
func (recv_ NvsHandleT) NvsGetU16(key *c.Char, out_value *c.Uint16T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsGetI32 C.nvs_get_i32
func (recv_ NvsHandleT) NvsGetI32(key *c.Char, out_value *c.Int32T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsGetU32 C.nvs_get_u32
func (recv_ NvsHandleT) NvsGetU32(key *c.Char, out_value *c.Uint32T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsGetI64 C.nvs_get_i64
func (recv_ NvsHandleT) NvsGetI64(key *c.Char, out_value *c.Int64T) EspErrT {
	return 0
}
 ...
 * This function is the same as \c nvs_get_i8 except for the data type.
 */
// llgo:link NvsHandleT.NvsGetU64 C.nvs_get_u64
func (recv_ NvsHandleT) NvsGetU64(key *c.Char, out_value *c.Uint64T) EspErrT {
	return 0
}
 ...
 */
// llgo:link NvsHandleT.NvsGetStr C.nvs_get_str
func (recv_ NvsHandleT) NvsGetStr(key *c.Char, out_value *c.Char, length *c.SizeT) EspErrT {
	return 0
}
 ...
 */
// llgo:link NvsHandleT.NvsGetBlob C.nvs_get_blob
func (recv_ NvsHandleT) NvsGetBlob(key *c.Char, out_value c.Pointer, length *c.SizeT) EspErrT {
	return 0
}
 ...
 *              - other error codes from the underlying storage driver
 */
// llgo:link NvsHandleT.NvsFindKey C.nvs_find_key
func (recv_ NvsHandleT) NvsFindKey(key *c.Char, out_type *NvsTypeT) EspErrT {
	return 0
}
 ...
 *              - other error codes from the underlying storage driver
 */
// llgo:link NvsHandleT.NvsEraseKey C.nvs_erase_key
func (recv_ NvsHandleT) NvsEraseKey(key *c.Char) EspErrT {
	return 0
}
 ...
 *              - other error codes from the underlying storage driver
 */
// llgo:link NvsHandleT.NvsEraseAll C.nvs_erase_all
func (recv_ NvsHandleT) NvsEraseAll() EspErrT {
	return 0
}
 ...
 *             - other error codes from the underlying storage driver
 */
// llgo:link NvsHandleT.NvsCommit C.nvs_commit
func (recv_ NvsHandleT) NvsCommit() EspErrT {
	return 0
}
 ...
 */
// llgo:link NvsHandleT.NvsClose C.nvs_close
func (recv_ NvsHandleT) NvsClose() {
}
...
type NvsStatsT struct {
	UsedEntries      c.SizeT
	FreeEntries      c.SizeT
	AvailableEntries c.SizeT
	TotalEntries     c.SizeT
	NamespaceCount   c.SizeT
}
...
*/
//go:linkname NvsGetStats C.nvs_get_stats
func NvsGetStats(part_name *c.Char, nvs_stats *NvsStatsT) EspErrT
 ...
 *               Return param used_entries will be filled 0.
 */
// llgo:link NvsHandleT.NvsGetUsedEntryCount C.nvs_get_used_entry_count
func (recv_ NvsHandleT) NvsGetUsedEntryCount(used_entries *c.SizeT) EspErrT {
	return 0
}
 ...
 */
//go:linkname NvsEntryFind C.nvs_entry_find
func NvsEntryFind(part_name *c.Char, namespace_name *c.Char, type_ NvsTypeT, output_iterator *NvsIteratorT) EspErrT
 ...
 *                  Note: don't release \c output_iterator in case ESP_ERR_INVALID_ARG has been returned
 */
// llgo:link NvsHandleT.NvsEntryFindInHandle C.nvs_entry_find_in_handle
func (recv_ NvsHandleT) NvsEntryFindInHandle(type_ NvsTypeT, output_iterator *NvsIteratorT) EspErrT {
	return 0
}
 ...
 */
//go:linkname NvsEntryNext C.nvs_entry_next
func NvsEntryNext(iterator *NvsIteratorT) EspErrT
 ...
 */
//go:linkname NvsEntryInfo C.nvs_entry_info
func NvsEntryInfo(iterator NvsIteratorT, out_info *NvsEntryInfoT) EspErrT
 ...
 *
 */
//go:linkname NvsReleaseIterator C.nvs_release_iterator
func NvsReleaseIterator(iterator NvsIteratorT)
