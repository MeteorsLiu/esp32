...
type EspSecureBootKeyDigestsT struct {
 ...
 */
//go:linkname EspEfuseEnableRomSecureDownloadMode C.esp_efuse_enable_rom_secure_download_mode
func EspEfuseEnableRomSecureDownloadMode() EspErrT
 ...
 */
// llgo:link EspEfuseBlockT.EspEfuseGetPurposeField C.esp_efuse_get_purpose_field
func (recv_ EspEfuseBlockT) EspEfuseGetPurposeField() **EspEfuseDescT {
	return nil
}
 ...
 * @return Pointer: If Successful returns a pointer to the corresponding efuse field otherwise NULL.
 */
// llgo:link EspEfuseBlockT.EspEfuseGetKey C.esp_efuse_get_key
func (recv_ EspEfuseBlockT) EspEfuseGetKey() **EspEfuseDescT {
	return nil
}
 ...
 *    - ESP_ERR_CODING: Error range of data does not match the coding scheme.
 */
// llgo:link EspEfuseBlockT.EspEfuseSetKeyPurpose C.esp_efuse_set_key_purpose
func (recv_ EspEfuseBlockT) EspEfuseSetKeyPurpose(purpose EspEfusePurposeT) EspErrT {
	return 0
}
 ...
 *    - ESP_ERR_CODING: Error range of data does not match the coding scheme.
 */
// llgo:link EspEfuseBlockT.EspEfuseSetKeypurposeDisWrite C.esp_efuse_set_keypurpose_dis_write
func (recv_ EspEfuseBlockT) EspEfuseSetKeypurposeDisWrite() EspErrT {
	return 0
}
 ...
 */
//go:linkname EspEfuseFindUnusedKeyBlock C.esp_efuse_find_unused_key_block
func EspEfuseFindUnusedKeyBlock() EspEfuseBlockT

/**
 * @brief Return the number of unused efuse key blocks in the range EFUSE_BLK_KEY0..EFUSE_BLK_KEY_MAX
 */
//go:linkname EspEfuseCountUnusedKeyBlocks C.esp_efuse_count_unused_key_blocks
func EspEfuseCountUnusedKeyBlocks() c.Uint
 ...
 */
//go:linkname EspEfuseGetDigestRevoke C.esp_efuse_get_digest_revoke
func EspEfuseGetDigestRevoke(num_digest c.Uint) bool
 ...
 *    - ESP_ERR_CODING: Error range of data does not match the coding scheme.
 */
//go:linkname EspEfuseSetDigestRevoke C.esp_efuse_set_digest_revoke
func EspEfuseSetDigestRevoke(num_digest c.Uint) EspErrT
 ...
 */
//go:linkname EspEfuseGetWriteProtectOfDigestRevoke C.esp_efuse_get_write_protect_of_digest_revoke
func EspEfuseGetWriteProtectOfDigestRevoke(num_digest c.Uint) bool
 ...
 *    - ESP_ERR_CODING: Error range of data does not match the coding scheme.
 */
//go:linkname EspEfuseSetWriteProtectOfDigestRevoke C.esp_efuse_set_write_protect_of_digest_revoke
func EspEfuseSetWriteProtectOfDigestRevoke(num_digest c.Uint) EspErrT
 ...
 */
// llgo:link (*EspSecureBootKeyDigestsT).EspSecureBootReadKeyDigests C.esp_secure_boot_read_key_digests
func (recv_ *EspSecureBootKeyDigestsT) EspSecureBootReadKeyDigests() EspErrT {
	return 0
}
