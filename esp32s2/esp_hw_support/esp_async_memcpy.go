 ...
 */
// llgo:link (*AsyncMemcpyConfigT).EspAsyncMemcpyInstallCpdma C.esp_async_memcpy_install_cpdma
func (recv_ *AsyncMemcpyConfigT) EspAsyncMemcpyInstallCpdma(mcp *AsyncMemcpyHandleT) EspErrT {
	return 0
}
