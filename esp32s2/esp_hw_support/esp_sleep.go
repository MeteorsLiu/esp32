...
const (
	...
	ESP_PD_DOMAIN_RTC_SLOW_MEM EspSleepPdDomainT = 1
	ESP_PD_DOMAIN_RTC_FAST_MEM EspSleepPdDomainT = 2
	ESP_PD_DOMAIN_XTAL         EspSleepPdDomainT = 3
	ESP_PD_DOMAIN_RC_FAST      EspSleepPdDomainT = 4
	ESP_PD_DOMAIN_VDDSDIO      EspSleepPdDomainT = 5
 ...
 *      - ESP_ERR_INVALID_STATE if wakeup triggers conflict
 */
//go:linkname EspSleepEnableExt0Wakeup C.esp_sleep_enable_ext0_wakeup
func EspSleepEnableExt0Wakeup(gpio_num GpioNumT, level c.Int) EspErrT
