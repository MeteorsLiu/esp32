...
const (
	...
	SPI_LL_INTR_IN_SUC_EOF    SpiLlIntrT = 2
	SPI_LL_INTR_OUT_EOF       SpiLlIntrT = 4
	SPI_LL_INTR_OUT_TOTAL_EOF SpiLlIntrT = 8
	SPI_LL_INTR_IN_FULL       SpiLlIntrT = 16
	SPI_LL_INTR_OUT_EMPTY     SpiLlIntrT = 32
