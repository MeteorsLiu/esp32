 ...
 */
// llgo:link (*SystimerHalContextT).SystimerHalSetStepsPerTick C.systimer_hal_set_steps_per_tick
func (recv_ *SystimerHalContextT) SystimerHalSetStepsPerTick(clock_source c.Int, steps c.Uint32T) {
}
